<?php
    ...
    use Librarys\Http\Detection\Exception\BadMethodCallException;
    ...
    class MobileDetect
    {
         ...
         * @return mixed
         * @throws \Librarys\Http\Detection\Exception\BadMethodCallException when the method doesn't exist and doesn't start with 'is'
         */
