<?php
    ...
    require_once(__DIR__ . DIRECTORY_SEPARATOR . 'Display.php');
    ...
    class Handler
    {
        ...
        private static function handlerListen()
        {
            set_exception_handler(function($exception) {
                Display::putExceptions($exception);
                Display::display();
            });
            ...
            register_shutdown_function(function() {
                ...
                if ($errorLabel !== false) {
                    Display::putError($errorLabel, $errorType, $errorMessage, $errorFile, $errorLine);
                    Display::display();
                }
            });
        }
